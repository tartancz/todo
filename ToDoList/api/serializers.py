...
class ToDoSerializer(serializers.ModelSerializer):
    ...
    created_by_api = serializers.HyperlinkedRelatedField(
        view_name="profile-detail", read_only=True, source="created_by"
    )
    created_by_web = serializers.HyperlinkedRelatedField(
        view_name="profile", read_only=True, source="created_by"
    )
...
class ProfileSerializerOwner(ProfileSerializer):
    gender = ShowFieldChangeSlugFieldRelatedField(
        slug_field="pk", queryset=Gender.objects.all()
    )
